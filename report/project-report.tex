...
\begin{itemize}
	...
	\item \textbf{Data Integrity:} Hashing and verification mechanisms are implemented to ensure that file chunks are not corrupted during transfer and tampered with.
\end{itemize}
